...
export const AuthBox = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className="w-full max-w-[min(100%,22rem)] sm:w-sm mx-auto space-y-4">
      <div className="p-5 sm:p-6 border rounded-lg sm:rounded-md bg-background shadow-sm">{children}</div>
      <Link
